$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Ariel and Tania's Wedding",

            // Event start date
            start: new Date('Decemeber 17, 2022 15:30'),

            // You can also choose to set an end time
            // If an end time is set, this will take precedence over duration
            end: new Date('December 17, 2022 21:00'),

            // Event Address
            address: 'STA. CLARA DE MONTEFALCO PARISH, Pasig City',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $.post('https://script.google.com/macros/s/AKfycbyOPvybY3fSGMsDm4liu-Z9KMPjHgITqZJzhXAfEUfPcVVfPSG0IYfyKMQhUiwWIGi8Zg/exec', data)
            .done(function (data) {
                console.log(data);
