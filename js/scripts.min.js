$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Whey and Bei's Wedding",

            // Event start date
            start: new Date('Decemeber 15, 2022 13:00'),

            // You can also choose to set an end time
            // If an end time is set, this will take precedence over duration
            end: new Date('December 15, 2022 21:00'),

            // Event Address
            address: 'SAN ANTONIO DE PADUA PARISH, Silang Cavite',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $.post('https://script.google.com/macros/s/AKfycbw9ThfF8NZnHRtxHUyNsUMomQntfAZt32vOwDLHYdguBep1RhW8FHJIKRavGWhDLcvf/exec', data)
            .done(function (data) {
                console.log(data);
